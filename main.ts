...
console.log(chalk.bold.rgb(204, 204, 204)(`<<<===========>>>  ${chalk.bold.hex(`#9999FF`)(`Welcome To \`Code With Shoaib Habib\` - Todo-List App `)} <<<===========>>> `));
console.log(chalk.bold.rgb(204, 204, 204)(`\t\t   <<<=============================================>>>\n`));
    ...
    let taskIndex = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: "Enter the message you want to delete:",
        }
    ]);
